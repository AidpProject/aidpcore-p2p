...
function builder(options) {
  ...
  if (!options.network) {
    options.network = aidpcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || aidpcore.Block;
  options.BlockHeader = options.BlockHeader || aidpcore.BlockHeader;
  options.Transaction = options.Transaction || aidpcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || aidpcore.MerkleBlock;
