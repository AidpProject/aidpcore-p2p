 ...
 * using the standard Aidpcoin protocol. A Peer instance represents one connection
 * on the Aidpcoin network. To create a new peer connection provide the host and port
