'use strict';
/* eslint-env es6 */
let Pool = require('aidpcore-p2p').Pool;
let BloomFilter = require('aidpcore-p2p').BloomFilter;
let NetworksData = require('aidpcore-lib').Networks;
let Messages = require('aidpcore-p2p').Messages;
...
// Create a filter and a aidpcoin message with the filter
...
// Create a aidpcoin message for require a merkleblock
